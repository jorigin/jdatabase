 ...
 *
 */
public class MySQLDatabase implements Database, Catalog, Schema{
   ...
   */
  public MySQLDatabase(String name, Server server, ArrayList<Table> tables){
    this.name   = name;
    this.server = server;
    this.tables = tables;
  }
   ...
   * @param server the name of the server
   */
  public MySQLDatabase(String name, Server server){
    this.name   = name;
    this.server = server;
