...
public class MySQLServer implements Server{
   ...
   */
  public MySQLServer(String name, ArrayList<Database> databases, DatabaseMetaData metaData){
    this.name      = name;
   ...
   * @param databases the list of databases hoster by the server
   */
  public MySQLServer(String name, ArrayList<Database> databases){
   ...
   */
  public MySQLServer(String name, DatabaseMetaData metaData){
