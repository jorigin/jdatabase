 ...
 *
 */
public class PGSQLServer implements Server{
  String name                   = null;
   ...
   */
  public PGSQLServer(String name, ArrayList<Database> databases, DatabaseMetaData metaData){
    this.name      = name;
   ...
   * @param databases the list of databases hoster by the server
   */
  public PGSQLServer(String name, ArrayList<Database> databases){
   ...
   */
  public PGSQLServer(String name, DatabaseMetaData metaData){
   ...
   * @param name the name of the server.
   */
  public PGSQLServer(String name){
