 ...
 * {@link org.jdatabase.jdbc.sql.Server database server} and a container of 
 * {@link org.jdatabase.jdbc.sql.Schema database schemas}.
...
public interface Catalog {
  ...
  /**
   * Get the {@link org.jdatabase.jdbc.sql.Schema schemas} contained by the catalog.
   * @return the schemas contained by the catalog.
   */
  public ArrayList<Schema> getSchemas();
  
  /**
   * Get the {@link org.jdatabase.jdbc.sql.Database database} hosting the catalog.
   * @return the database containing the catalog.
   */
  public Database getDatabase();
  
  /**
   * Get the {@link org.jdatabase.jdbc.sql.Server server} containing the catalog.
  ...
  /**
   * Add a {@link org.jdatabase.jdbc.sql.Schema schema} to the catalog. The schema is added only if it is not already present
   * in the catalog.
  ...
  /**
   * Remove the {@link org.jdatabase.jdbc.sql.Schema schema} given in parameter from the catalog.
