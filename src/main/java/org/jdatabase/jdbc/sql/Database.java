...
/**
 * This classes describe a database. The database is hosted by a {@link org.jdatabase.jdbc.sql.Server server} and contains a 
 * collection of {@link org.jdatabase.jdbc.sql.Catalog catalogs}.
...
public interface Database {
  ...
  /**
   * Get the {@link org.jdatabase.jdbc.sql.Catalog catalogs} contained within the database.
   * @return the catalogs contained within the database.
   */
  public ArrayList<Catalog> getCatalogs();

  /**
   * Get the {@link org.jdatabase.jdbc.sql.Schema schemas} contained by the database.
   * @return the schemas contained by the database.
   */
  public ArrayList<Schema> getSchemas();
  
  /**
   * Get the {@link org.jdatabase.jdbc.sql.Server server} hosting the database.
  ...
  /**
   * Add a {@link org.jdatabase.jdbc.sql.Catalog catalog} to the database. 
  ...
  /**
   * Remove the {@link org.jdatabase.jdbc.sql.Catalog catalog} given in parameter from the database.
  ...
  /**
   * Add a {@link org.jdatabase.jdbc.sql.Schema schema} to the database. The schema is added only if it is not already present
   * in the database.
  ...
  /**
   * Remove the {@link org.jdatabase.jdbc.sql.Schema schema} given in parameter from the database.
