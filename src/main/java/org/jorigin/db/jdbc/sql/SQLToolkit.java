...
public interface SQLToolkit {
  ...
  /**
   * Get the {@link org.jorigin.db.jdbc.JDBCConnection connection} attached to the toolkit
   * @return the connection attached to the toolkit.
   * @see org.jorigin.db.jdbc.JDBCConnection
   */
  public JDBCConnection getConnection();
  
  /**
   * Map the entire {@link org.jorigin.db.jdbc.sql.Server server}. This method create a tree representing the server and
   * the databases hosted. Each {@link org.jorigin.db.jdbc.sql.Database database} is recursively mapped.
  ...
  /**
   * List all the {@link org.jorigin.db.jdbc.sql.Database databases} accessible by a the user logged on the server given in parameter.
  ...
  /**
   * Create a new {@link org.jorigin.db.jdbc.sql.Database database} with name given by <code>dbName</code> on the given 
  ...
  /**
   * Delete a {@link org.jorigin.db.jdbc.sql.Database database} from the server. All data within the database are deleted.
  ...
  /**
   * List the {@link org.jorigin.db.jdbc.sql.Catalog catalogs} attached to the given database.
  ...
  /**
   * Create a new {@link org.jorigin.db.jdbc.sql.Catalog catalog} within the database. The catalog is created only if it does not exist.
   ...
   * @param database the {@link org.jorigin.db.jdbc.sql.Database database} which the catalog is attached.
  ...
  /**
   * Delete the given {@link org.jorigin.db.jdbc.sql.Catalog catalog} from the {@link org.jorigin.db.jdbc.sql.Database database}.
  ...
  /**
   * List all the {@link org.jorigin.db.jdbc.sql.Schema schemas} available within the given {@link org.jorigin.db.jdbc.sql.Database database}.
  ...
  /**
   * Create a {@link org.jorigin.db.jdbc.sql.Schema schema} within the given {@link org.jorigin.db.jdbc.sql.Database database}
  ...
  /**
   * Delete the given {@link org.jorigin.db.jdbc.sql.Schema schema} from its {@link org.jorigin.db.jdbc.sql.Catalog catalog}
  ...
  /**
   * List all {@link org.jorigin.db.jdbc.sql.Table tables} of the {@link org.jorigin.db.jdbc.sql.Schema schema} 
  ...
  /**
   * Delete (drop) the {@link org.jorigin.db.jdbc.sql.Table tables} given in parameter.
  ...
  /**
   * Return the content of the given {@link org.jorigin.db.jdbc.sql.Table table} as an array of object. 
